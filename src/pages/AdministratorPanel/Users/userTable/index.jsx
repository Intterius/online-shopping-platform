...
import {AppContextUsers} from "../index";
...
const headCells = [
    ...
    { id: 'enabled', numeric: true, disablePadding: false, label: 'Active' }
];
...
export default function UserTable() {
    ...
    const {userList} = useContext(AppContextUsers)
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.enabled ? "Active": "Disable"}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
